export const es = {
  ...
  settings: {
    ...
    deleteFilesDesc: "Al activar esta opción, el archivo de audio se eliminará permanentemente de tu computadora cuando elimines una pista del historial de RipTune.",
