      ...
      <div className="w-full rounded-3xl bg-[#111728]/80 backdrop-blur-xl border border-white/5 shadow-2xl p-8">
        ...
        <div className="mb-6 border-b border-white/10 pb-6">
          ...
          <div className="flex items-center justify-between gap-4 py-2">
            <div className="flex-1">
              <p className="text-white font-medium mb-1">
                {t.settings.partialAnalysis}
              </p>
              <p className="text-slate-400 text-xs text-pretty">
                {t.settings.partialAnalysisDesc}
              </p>
              <div className="flex items-end gap-1.5 mt-1.5">
                <AlertTriangle className="w-3 h-3 text-amber-500/80 shrink-0" />
                <p className="text-amber-500/80 text-[10px] leading-none font-semibold uppercase tracking-wider">
                  {t.settings.partialAnalysisWarning}
                </p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="mb-6 border-b border-white/10 pb-6">
          ...
          <input
            ...
            className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-3 text-slate-300 font-mono text-xs shadow-inner focus:outline-none focus:border-purple-500/50 transition-colors"
          />
        </div>
        ...
        <div className="pt-2">
          ...
          <p className="text-slate-400 text-sm leading-relaxed mb-4">
            ...
            <a
              ...
              className="text-purple-400 hover:text-purple-300 font-bold decoration-dotted underline underline-offset-4 transition-colors"
            >
              @HugoSohm
            </a>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 rounded-xl text-purple-400 text-xs font-bold transition-all group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/20 rounded-xl text-emerald-400 text-xs font-bold transition-all group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 rounded-xl text-indigo-400 text-xs font-bold transition-all group"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                className="w-3 h-3 fill-current transition-transform group-hover:scale-110"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#29abe0]/10 hover:bg-[#29abe0]/20 border border-[#29abe0]/20 rounded-xl text-[#29abe0] text-xs font-bold transition-all group"
            >
              <img
                src="https://storage.ko-fi.com/cdn/cup-border.png"
                alt="Ko-fi"
                className="w-4 h-4 animation-bounce-subtle"
              />
              {t.settings.koFi}
              <ExternalLink className="w-2.5 h-2.5 opacity-60 ml-px" />
            </a>
