import { FolderOpen, UploadCloud, Trash2, Info, X, Languages, ExternalLink, Activity, AlertTriangle, Globe } from "lucide-react";
      ...
      <div className="w-full rounded-3xl bg-[#111728]/80 backdrop-blur-xl border border-white/5 shadow-2xl p-8">
        ...
        <div className="pt-2">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a href="https://github.com/HugoSohm/riptune" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-slate-400 hover:text-purple-400 text-xs font-bold transition-all group">
