  ...
  return (
    <div className="fixed top-[72px] right-6 z-[100001] flex flex-col gap-3 max-w-sm pointer-events-auto">
      {notifications.map((notification) => (
        ...
        >
          <div
            className={`shrink-0 p-2.5 rounded-xl ${notification.type === "error" ? "bg-red-500/20 text-red-400" : notification.type === "success" ? "bg-emerald-500/20 text-emerald-400" : "bg-purple-500/20 text-purple-400"}`}
          >
          ...
          <div className="flex-1 min-w-0 pr-6">
            ...
            <p
              className={`text-xs font-semibold leading-relaxed break-words ${notification.type === "error" ? "text-red-300" : notification.type === "success" ? "text-emerald-300" : "text-slate-100"}`}
            >
