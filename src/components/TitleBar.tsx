      ...
      <div className="flex items-center h-full">
        ...
        <div className="flex items-center gap-2 mr-4" onMouseDown={(e) => e.stopPropagation()}>
          ...
          <div className="group relative">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-1.5 bg-slate-900/90 backdrop-blur-md border border-white/10 text-white text-[11px] rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 delay-0 group-hover:delay-500 pointer-events-none whitespace-nowrap z-50 shadow-2xl scale-95 group-hover:scale-100 font-medium flex items-center gap-2">
